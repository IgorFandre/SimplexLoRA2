def set_arguments_libsvm(parser):
    ### Dataset Arguments
    parser.add_argument("--dataset", default="mushrooms", 
                         choices=["mushrooms", "binary"], 
                         help="Dataset name")
    ...
    ### Model Arguments
    parser.add_argument("--model", default="linear-classifier", 
    ...
    parser.add_argument("--tune", action="store_true", 
                        help="Tune params")
    parser.add_argument("--n_epoches_tune", default=1, 
                        type=int, help="How many epochs to tune with optuna")
    parser.add_argument("--tune_runs", default=20, type=int, 
